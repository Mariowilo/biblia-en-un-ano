...
const CACHE = 'biblia365-v7';
const FILES = ['./', 'index.html', 'biblia.html', 'plan.js', 'comentarios.js', 'confesiones.js', 'estudio.js', 'contextos.js', 'manifest.json', 'Logo Ad Fontes.png'];
